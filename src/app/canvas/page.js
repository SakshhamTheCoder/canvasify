    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-start p-24 w-full">
            {user == null ? (
                ...
                <>
                    <div className="flex justify-center flex-col m-4 rounded-3xl bg-zinc-900">
                        <div className="m-5 flex justify-between items-center flex-col sm:flex-row">
                            <img
                        ...
                        <hr className="w-96 h-1 mx-auto border-0 rounded bg-zinc-700" />
                    ...
                    {nowPLaying == null ? (
                        ...
                        <div
                            ...
                            className={
                                'w-full md:w-1/2 rounded-3xl bg-[image:var(--image-url)] bg-cover bg-center bg-no-repeat'
                            }
                        >
                            <div className="backdrop-blur-3xl backdrop-brightness-75 flex flex-col items-center p-4 rounded-3xl md:justify-evenly md:flex-row ">
                                ...
                                <div className="flex justify-center items-center flex-col flex-grow mx-4">
                                    <h1 className="text-4xl font-bold text-center mx-3 overflow-ellipsis">
                                        {nowPLaying.item.name}
                                    </h1>
                                    <p className="text-2xl text-center">{nowPLaying.item.artists[0].name}</p>
